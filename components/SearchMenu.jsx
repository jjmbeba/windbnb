  ...
  return (
    <div className='w-screen h-[88vh] absolute top-0 left-0 bg-white px-[22px] '>
        ...
        <div className='md:my-[93px] my-[16px] rounded-[16px] shadow-search md:flex'>
            ...
            <div onClick={handleGuestClick} className={`container ml-[10px] border border-solid border-transparent border-t-[#F2F2F2] ${active.guests && 'border border-solid rounded-[16px] border-[#333333] border-t-[#333333]'}`}>
